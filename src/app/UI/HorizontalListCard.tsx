...
const HorizontalListCard = (props: Props) => {
  return (
    <div className="w-[496px] h-[106px] p-3 bg-purple-800 rounded flex-col justify-center items-start gap-3 flex">
                                        <div className="h-[60px]  flex ">
                                            ...
                                            <div className=" pl-3.5 pr-[15px] pt-4 pb-[13px] h-10 w-10 my-auto bg-purple-600 rounded justify-center items-center flex">
                                                <Image height='14' width='14' alt='search icon' src={DownloadIcon} />
                                            </div>
                                        </div>
                                        <div className="w-[459px] h-2.5 pr-[321px] bg-gray-700 rounded-full justify-start items-center flex">

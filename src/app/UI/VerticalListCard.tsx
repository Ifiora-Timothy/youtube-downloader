...
const VerticalListCard = (props: Props) => {
  return (
    ...
    <div className="w-[315px] h-7 justify-center items-center inline-flex">
    ...
    <div className='flex-col text-zinc-200 text-[13px] items-center flex'>
        <div className="w-[315px] h-5  justify-center items-center inline-flex">
    ...
    <div className="  pt-4 pb-[13px] h-10 w-10 my-auto bg-purple-600 rounded justify-center items-center inline-flex">
        <Image height='14' width='14' alt='search icon' src={DownloadIcon} />
    </div>
    <div className="w-[290px] mt-2 h-2.5 pr-[252px] bg-gray-700 rounded-full justify-start items-center inline-flex">

...
const EmptyDownload = (props: Props) => {
    return (
        <div className="w-[896px] h-[300px] px-4 justify-center items-center gap-10 inline-flex">
            <div className="w-[412px] h-[228px] relative flex-col justify-start items-start flex">
                <div className="pr-[179px] pb-0.5 justify-start items-center inline-flex">
            ...
            <div className="grow shrink basis-0 h-[300px] pr-3 justify-start items-center inline-flex">

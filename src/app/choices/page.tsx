...
const Choices
 = (props: Props) => {
  return (
<div className="w-full h-[100vh]  bg-purple-900 justify-center pt-24 inline-flex">
<div className="w-[448px] h-[416px] p-8 bg-purple-800 rounded-lg shadow flex-col justify-center items-start gap-4 inline-flex">
    <div className="self-stretch h-8 pl-[37px] pr-[38px] justify-center items-center inline-flex">
        <div className="w-[309px] text-center text-white text-2xl font-bold font-['Roboto'] leading-loose">What would you like to do?</div>
    </div>
    <div className="self-stretch grow shrink basis-0 flex-col justify-center items-start gap-4 inline-flex">
        <div className="self-stretch grow shrink basis-0 p-3 bg-purple-700 rounded justify-center items-center inline-flex">

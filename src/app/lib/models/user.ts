...
if(validate instanceof Error){
  ...
  const user = { name: emailExist.username, email: emailExist.email, id: emailExist._id }
  return user
}

UserSchema.statics.findByEmailAndUsername = async function({email,username}:{email:string,username:string}){

...
const page = () => {
    ...
    return (
        <div className="w-full h-[90vh]  bg-purple-600 justify-center pt-20  flex">
            <div className="w-[371px] h-[387px] relative flex flex-col items-center gap-2 pt-10 bg-white rounded-[19px] shadow">
                <div className="pl-[23px] pr-[22px] py-px bg-red-900 bg-opacity-0 mt-2 justify-center items-center inline-flex">

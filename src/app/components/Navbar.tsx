...
const Navbar = (props: Props) => {
    return (
        <nav className="w-full h-[68px] pl-14 pr-[55px] py-4  bg-purple-800  justify-center items-center flex">
            <div className="grow shrink basis-0 self-stretch pl-4 pr-[17px] justify-center items-center gap-[512px] flex">
                ...
                <div className="w-[330px] h-6 pt-px pb-0.5 justify-center items-start gap-5 flex">
